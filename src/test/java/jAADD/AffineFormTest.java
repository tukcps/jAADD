...
public class AffineFormTest {
    ...
    private static AffineForm af1, af2, scl, lgr, rst;
    ...
    public void testAddScalars() {
        ...
        assertEquals(sum1.getCentral(), sum2.getCentral());
    }*/
    ...
    public void testAddNaN() {
        AffineForm af3 = new AffineForm(Double.NaN);
        AffineForm sum1 = af3.add(af1);
        AffineForm sum2 = af1.add(af3);
...
/*
    ...
    public void testMultScalar() {
        ...
        assertEquals(AffineForm.Type.FINITE, prod1.getType());
        assertEquals(AffineForm.Type.INFINITE, prod2.getType());
        // Not true ... the multiplication introduces some quantization fault that
        // we model as Affine Form.
        // assertEquals(AffineForm.Type.SCALAR, prod3.getType());
        assertEquals(AffineForm.Type.INFINITE, prod4.getType());
...
//		}
    ...
    public void testConstructionExceptionRange() {
        ...
        assertEquals("Trying to create range with inverted range: [2.0, 1.0]", exception.getMessage());
    }*/


    @Test
    public void isSimilarTest() {
        AffineForm a = new AffineForm(1,2,1);
        AffineForm b = new AffineForm (1,2,1);
        assertTrue(a.isSimilar(b, 0.000001));

        b = new AffineForm(1, 2, 2);
    ...
    public void joinTest() {
        AffineForm a = new AffineForm(1,2,1);
        AffineForm b = new AffineForm (2,3,1);
        assertEquals(2.0, a.join(b).getCentral());

        b = new AffineForm(2, 3, 2);
        assertEquals(2.0, a.join(b).getCentral());
    }
    ...
    public void jsonTest() {
       ...
       // Gson gson = new Gson();
        ...
        System.out.println("JSON string of af1+af2: " + json);
    }
}
